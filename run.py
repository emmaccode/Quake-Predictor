...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Emmett Boudreau', className='mr-2'),
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:emmett@emmettboudreau.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/emmettgb'),
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/emmett-boudreau-828b2818a/'),
                ],
                className='lead'
            )
        )
